module github.com/duc-cnzj/mars/v6

go 1.26.7

replace github.com/duc-cnzj/mars/api/v6 => ./api
...
require (
	...
	github.com/duc-cnzj/mars/api/v6 v6.0.0
...
require (
	...
	github.com/docker/docker v25.0.17+incompatible // indirect
