...
const file_git_git_proto_rawDesc = "" +
	"\n" +
	"\rgit/git.proto\x12\x03git\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17validate/validate.proto\x1a\x1copenapi/v3/annotations.proto\"\xe5\x01\n" +
	"\x06Option\x12\x14\n" +
	...
	"\x12GetChartValuesYaml\x12\x1e.git.GetChartValuesYamlRequest\x1a\x1f.git.GetChartValuesYamlResponse\"P\xbaG$\x12\"获取 helm charts 的 values.yaml\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/api/git/get_chart_values_yamlB)Z'github.com/duc-cnzj/mars/api/v5/git;gitb\x06proto3"
