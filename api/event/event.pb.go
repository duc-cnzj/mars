...
const file_event_event_proto_rawDesc = "" +
	"\n" +
	"\x11event/event.proto\x12\x05event\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a\x11types/types.proto\x1a\x1copenapi/v3/annotations.proto\"\xb0\x01\n" +
	...
	"\x04Show\x12\x12.event.ShowRequest\x1a\x13.event.ShowResponse\"@\xbaG%\x12#查看事件详情, 包含 old, new\x82\xd3\xe4\x93\x02\x12\x12\x10/api/events/{id}B-Z+github.com/duc-cnzj/mars/api/v5/event;eventb\x06proto3"
