...
const file_changelog_changelog_proto_rawDesc = "" +
	"\n" +
	"\x19changelog/changelog.proto\x12\tchangelog\x1a\x1cgoogle/api/annotations.proto\x1a\x1copenapi/v3/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17validate/validate.proto\x1a\x11types/types.proto\"u\n" +
	...
	"\x1dFindLastChangelogsByProjectID\x12/.changelog.FindLastChangelogsByProjectIDRequest\x1a0.changelog.FindLastChangelogsByProjectIDResponse\"Z\xbaG\x1a\x12\x18查看项目改动日志\x82\xd3\xe4\x93\x027:\x01*\"2/api/changelogs/find_last_changelogs_by_project_idB5Z3github.com/duc-cnzj/mars/api/v5/changelog;changelogb\x06proto3"

var (
	file_changelog_changelog_proto_rawDescOnce sync.Once
	file_changelog_changelog_proto_rawDescData []byte
)

func file_changelog_changelog_proto_rawDescGZIP() []byte {
	file_changelog_changelog_proto_rawDescOnce.Do(func() {
		file_changelog_changelog_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_changelog_changelog_proto_rawDesc), len(file_changelog_changelog_proto_rawDesc)))
	})
...
var file_changelog_changelog_proto_goTypes = []any{
...
func file_changelog_changelog_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_changelog_changelog_proto_rawDesc), len(file_changelog_changelog_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
