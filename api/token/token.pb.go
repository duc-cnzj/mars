...
const file_token_token_proto_rawDesc = "" +
	"\n" +
	"\x11token/token.proto\x12\x05token\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a\x11types/types.proto\"_\n" +
	...
	"\x06Revoke\x12\x14.token.RevokeRequest\x1a\x15.token.RevokeResponse\"\"\x82\xd3\xe4\x93\x02\x1c*\x1a/api/access_tokens/{token}B-Z+github.com/duc-cnzj/mars/api/v5/token;tokenb\x06proto3"
...
func file_token_token_proto_init() {
	...
	file_token_token_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
