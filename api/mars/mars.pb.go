...
const file_mars_mars_proto_rawDesc = "" +
	"\n" +
	"\x0fmars/mars.proto\x12\x04mars\x1a\x17validate/validate.proto\"\xa8\x03\n" +
	"\x06Config\x12\x1f\n" +
	...
	"\x16ElementTypeNumberRadio\x10\bB&Z$github.com/duc-cnzj/mars/api/v5/marsb\x06proto3"

var (
	file_mars_mars_proto_rawDescOnce sync.Once
	file_mars_mars_proto_rawDescData []byte
)

func file_mars_mars_proto_rawDescGZIP() []byte {
	file_mars_mars_proto_rawDescOnce.Do(func() {
		file_mars_mars_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mars_mars_proto_rawDesc), len(file_mars_mars_proto_rawDesc)))
	})
...
var file_mars_mars_proto_goTypes = []any{
...
func file_mars_mars_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mars_mars_proto_rawDesc), len(file_mars_mars_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
