...
const file_cluster_cluster_proto_rawDesc = "" +
	"\n" +
	"\x15cluster/cluster.proto\x12\acluster\x1a\x1cgoogle/api/annotations.proto\x1a\x1copenapi/v3/annotations.proto\x1a\x19websocket/websocket.proto\":\n" +
	"\fInfoResponse\x12*\n" +
	...
	"\aCluster\x12n\n" +
	"\vClusterInfo\x12\x14.cluster.InfoRequest\x1a\x15.cluster.InfoResponse\"2\xbaG\x16\x12\x12查看集群信息Z\x00\x82\xd3\xe4\x93\x02\x13\x12\x11/api/cluster_infoB1Z/github.com/duc-cnzj/mars/api/v5/cluster;clusterb\x06proto3"
