...
const file_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x0fauth/auth.proto\x12\x04auth\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17validate/validate.proto\x1a\x1copenapi/v3/annotations.proto\"`\n" +
	"\fLoginRequest\x12'\n" +
	...
	"\bExchange\x12\x15.auth.ExchangeRequest\x1a\x16.auth.ExchangeResponse\"9\xbaG\x19\x12\x15sso code 换取 tokenZ\x00\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/api/auth/exchangeBi\xbaG;*':%\n" +
	"#\n" +
	"\n" +
	"BearerAuth\x12\x15\n" +
	"\x13\n" +
	...
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00Z)github.com/duc-cnzj/mars/api/v5/auth;authb\x06proto3"
