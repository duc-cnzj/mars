...
const file_metrics_metrics_proto_rawDesc = "" +
	"\n" +
	"\x15metrics/metrics.proto\x12\ametrics\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17validate/validate.proto\x1a\x1copenapi/v3/annotations.proto\"Y\n" +
	"\rTopPodRequest\x12)\n" +
	...
	"\fStreamTopPod\x12\x16.metrics.TopPodRequest\x1a\x17.metrics.TopPodResponse\"q\xbaG2\x120stream 的方式获取 pod 的 cpu memory 信息\x82\xd3\xe4\x93\x026\x124/api/metrics/namespace/{namespace}/pods/{pod}/stream0\x01B1Z/github.com/duc-cnzj/mars/api/v5/metrics;metricsb\x06proto3"
