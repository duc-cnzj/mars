...
const file_picture_picture_proto_rawDesc = "" +
	"\n" +
	"\x15picture/picture.proto\x12\apicture\x1a\x1cgoogle/api/annotations.proto\x1a\x1copenapi/v3/annotations.proto\"+\n" +
	...
	"\aPicture\x12k\n" +
	"\n" +
	"Background\x12\x1a.picture.BackgroundRequest\x1a\x1b.picture.BackgroundResponse\"$\xbaG\x02Z\x00\x82\xd3\xe4\x93\x02\x19\x12\x17/api/picture/backgroundB1Z/github.com/duc-cnzj/mars/api/v5/picture;pictureb\x06proto3"

var (
	file_picture_picture_proto_rawDescOnce sync.Once
	file_picture_picture_proto_rawDescData []byte
)

func file_picture_picture_proto_rawDescGZIP() []byte {
	file_picture_picture_proto_rawDescOnce.Do(func() {
		file_picture_picture_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_picture_picture_proto_rawDesc), len(file_picture_picture_proto_rawDesc)))
	})
	return file_picture_picture_proto_rawDescData
}

var file_picture_picture_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_picture_picture_proto_goTypes = []any{
...
func file_picture_picture_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_picture_picture_proto_rawDesc), len(file_picture_picture_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
