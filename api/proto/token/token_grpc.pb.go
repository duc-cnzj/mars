...
func (c *accessTokenClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccessToken_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessTokenClient) Grant(ctx context.Context, in *GrantRequest, opts ...grpc.CallOption) (*GrantResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccessToken_Grant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessTokenClient) Lease(ctx context.Context, in *LeaseRequest, opts ...grpc.CallOption) (*LeaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccessToken_Lease_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessTokenClient) Revoke(ctx context.Context, in *RevokeRequest, opts ...grpc.CallOption) (*RevokeResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccessToken_Revoke_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAccessTokenServer must be embedded to have
...
func (UnimplementedAccessTokenServer) testEmbeddedByValue()                     {}
...
func RegisterAccessTokenServer(s grpc.ServiceRegistrar, srv AccessTokenServer) {
	// If the following call panics, it indicates UnimplementedAccessTokenServer was
