...
const file_endpoint_endpoint_proto_rawDesc = "" +
	"\n" +
	"\x17endpoint/endpoint.proto\x12\bendpoint\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x17validate/validate.proto\x1a\x11types/types.proto\x1a\x1copenapi/v3/annotations.proto\"D\n" +
	...
	"\tInProject\x12\x1a.endpoint.InProjectRequest\x1a\x1b.endpoint.InProjectResponse\"S\xbaG$\x12\"获取项目下所有的 endpoints\x82\xd3\xe4\x93\x02&\x12$/api/endpoints/projects/{project_id}B3Z1github.com/duc-cnzj/mars/api/v5/endpoint;endpointb\x06proto3"

var (
	file_endpoint_endpoint_proto_rawDescOnce sync.Once
	file_endpoint_endpoint_proto_rawDescData []byte
)

func file_endpoint_endpoint_proto_rawDescGZIP() []byte {
	file_endpoint_endpoint_proto_rawDescOnce.Do(func() {
		file_endpoint_endpoint_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_endpoint_endpoint_proto_rawDesc), len(file_endpoint_endpoint_proto_rawDesc)))
	})
	return file_endpoint_endpoint_proto_rawDescData
}

var file_endpoint_endpoint_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_endpoint_endpoint_proto_goTypes = []any{
...
func file_endpoint_endpoint_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_endpoint_endpoint_proto_rawDesc), len(file_endpoint_endpoint_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
