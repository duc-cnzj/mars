  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // 不要加 text-balance：tooltip 长文本按内容宽换行，balance 会把折行压成多行等宽、
          // 首行不占满就换行（且 inline text-wrap:normal shorthand 压不掉它写的 longhand
          // text-wrap-style:balance，Chrome 长短属性交互怪癖，见 Elements FieldLabel 注释）
