...
export const auth = ($root.auth = (() => {
  ...
  auth.LoginResponse = (function () {
     ...
     * @instance
     */
    LoginResponse.prototype.expires_in = $util.Long
    ...
    LoginResponse.encode = function encode(message, writer) {
      ...
      if (
        message.expires_in != null &&
        Object.hasOwnProperty.call(message, "expires_in")
      )
  ...
  auth.ExchangeRequest = (function () {
    ...
    ExchangeRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.auth.ExchangeRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  auth.ExchangeResponse = (function () {
     ...
     * @instance
     */
    ExchangeResponse.prototype.expires_in = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ExchangeResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.auth.ExchangeResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  auth.InfoRequest = (function () {
    ...
    InfoRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.auth.InfoRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  auth.InfoResponse = (function () {
    ...
    InfoResponse.encode = function encode(message, writer) {
      ...
      if (
        message.logout_url != null &&
        Object.hasOwnProperty.call(message, "logout_url")
      )
    ...
    InfoResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.auth.InfoResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  auth.SettingsRequest = (function () {
    ...
    SettingsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.auth.SettingsRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  auth.SettingsResponse = (function () {
    ...
    SettingsResponse.encode = function encode(message, writer) {
      ...
      if (message.items != null && message.items.length)
        for (let i = 0; i < message.items.length; ++i)
          $root.auth.SettingsResponse.OidcSetting.encode(
            message.items[i],
    ...
    SettingsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.auth.SettingsResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            ...
            message.items.push(
              $root.auth.SettingsResponse.OidcSetting.decode(
                reader,
                reader.uint32()
              )
            );
    ...
    SettingsResponse.OidcSetting = (function () {
      ...
      OidcSetting.encode = function encode(message, writer) {
        ...
        if (
          message.end_session_endpoint != null &&
          Object.hasOwnProperty.call(message, "end_session_endpoint")
        )
          writer
            .uint32(/* id 4, wireType 2 =*/ 34)
            .string(message.end_session_endpoint);
        if (
          message.state != null &&
      ...
      OidcSetting.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.auth.SettingsResponse.OidcSetting();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
  ...
  auth.Auth = (function () {
     ...
     */
    Object.defineProperty(
      (Auth.prototype.info = function info(request, callback) {
        return this.rpcCall(
          info,
          $root.auth.InfoRequest,
          $root.auth.InfoResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Auth.prototype.settings = function settings(request, callback) {
        return this.rpcCall(
          settings,
          $root.auth.SettingsRequest,
          $root.auth.SettingsResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Auth.prototype.exchange = function exchange(request, callback) {
        return this.rpcCall(
          exchange,
          $root.auth.ExchangeRequest,
          $root.auth.ExchangeResponse,
          request,
          callback
        );
      }),
...
export const changelog = ($root.changelog = (() => {
  ...
  changelog.ShowRequest = (function () {
     ...
     * @instance
     */
    ShowRequest.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ShowRequest.encode = function encode(message, writer) {
      ...
      if (
        message.only_changed != null &&
        Object.hasOwnProperty.call(message, "only_changed")
      )
    ...
    ShowRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.changelog.ShowRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  changelog.ShowResponse = (function () {
    ...
    ShowResponse.encode = function encode(message, writer) {
      ...
      if (message.items != null && message.items.length)
        for (let i = 0; i < message.items.length; ++i)
          $root.types.ChangelogModel.encode(
            message.items[i],
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
          ).ldelim();
      return writer;
    ...
    ShowResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.changelog.ShowResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.ChangelogModel.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  changelog.Changelog = (function () {
    ...
    (Changelog.prototype = Object.create(
      $protobuf.rpc.Service.prototype
     ...
     */
    Object.defineProperty(
      (Changelog.prototype.show = function show(request, callback) {
        return this.rpcCall(
          show,
          $root.changelog.ShowRequest,
          $root.changelog.ShowResponse,
          request,
          callback
        );
      }),
...
export const cluster = ($root.cluster = (() => {
  ...
  cluster.InfoResponse = (function () {
    ...
    InfoResponse.encode = function encode(message, writer) {
      ...
      if (
        message.free_memory != null &&
        Object.hasOwnProperty.call(message, "free_memory")
      )
        writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.free_memory);
      if (
        message.free_cpu != null &&
        Object.hasOwnProperty.call(message, "free_cpu")
      )
        writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.free_cpu);
      if (
        message.free_request_memory != null &&
        Object.hasOwnProperty.call(message, "free_request_memory")
      )
        writer
          .uint32(/* id 4, wireType 2 =*/ 34)
          .string(message.free_request_memory);
      if (
        message.free_request_cpu != null &&
        Object.hasOwnProperty.call(message, "free_request_cpu")
      )
        writer
          .uint32(/* id 5, wireType 2 =*/ 42)
          .string(message.free_request_cpu);
      if (
        message.total_memory != null &&
        Object.hasOwnProperty.call(message, "total_memory")
      )
        writer.uint32(/* id 6, wireType 2 =*/ 50).string(message.total_memory);
      if (
        message.total_cpu != null &&
        Object.hasOwnProperty.call(message, "total_cpu")
      )
        writer.uint32(/* id 7, wireType 2 =*/ 58).string(message.total_cpu);
      if (
        message.usage_memory_rate != null &&
        Object.hasOwnProperty.call(message, "usage_memory_rate")
      )
        writer
          .uint32(/* id 8, wireType 2 =*/ 66)
          .string(message.usage_memory_rate);
      if (
        message.usage_cpu_rate != null &&
        Object.hasOwnProperty.call(message, "usage_cpu_rate")
      )
        writer
          .uint32(/* id 9, wireType 2 =*/ 74)
          .string(message.usage_cpu_rate);
      if (
        message.request_memory_rate != null &&
        Object.hasOwnProperty.call(message, "request_memory_rate")
      )
        writer
          .uint32(/* id 10, wireType 2 =*/ 82)
          .string(message.request_memory_rate);
      if (
        message.request_cpu_rate != null &&
        Object.hasOwnProperty.call(message, "request_cpu_rate")
      )
        writer
          .uint32(/* id 11, wireType 2 =*/ 90)
          .string(message.request_cpu_rate);
      return writer;
    };
    ...
    InfoResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.cluster.InfoResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  cluster.InfoRequest = (function () {
    ...
    InfoRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.cluster.InfoRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  cluster.Cluster = (function () {
     ...
     */
    Object.defineProperty(
      (Cluster.prototype.clusterInfo = function clusterInfo(request, callback) {
        return this.rpcCall(
          clusterInfo,
          $root.cluster.InfoRequest,
          $root.cluster.InfoResponse,
          request,
          callback
        );
      }),
...
export const container = ($root.container = (() => {
  ...
  container.CopyToPodRequest = (function () {
     ...
     * @instance
     */
    CopyToPodRequest.prototype.file_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    CopyToPodRequest.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "file_id")
      )
    ...
    CopyToPodRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.CopyToPodRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.CopyToPodResponse = (function () {
    ...
    CopyToPodResponse.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.pod_file_path != null &&
        Object.hasOwnProperty.call(message, "pod_file_path")
      )
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "file_name")
      )
    ...
    CopyToPodResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.CopyToPodResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.ExecRequest = (function () {
    ...
    ExecRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.ExecRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.ExecError = (function () {
     ...
     * @instance
     */
    ExecError.prototype.code = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ExecError.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.ExecError();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.ExecResponse = (function () {
    ...
    ExecResponse.encode = function encode(message, writer) {
      ...
      if (message.error != null && Object.hasOwnProperty.call(message, "error"))
        $root.container.ExecError.encode(
          message.error,
    ...
    ExecResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.ExecResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            message.error = $root.container.ExecError.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  container.StreamCopyToPodRequest = (function () {
    ...
    StreamCopyToPodRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.StreamCopyToPodRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.StreamCopyToPodResponse = (function () {
     ...
     * @instance
     */
    StreamCopyToPodResponse.prototype.size = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    StreamCopyToPodResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.StreamCopyToPodResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.IsPodRunningRequest = (function () {
    ...
    IsPodRunningRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.IsPodRunningRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.IsPodRunningResponse = (function () {
    ...
    IsPodRunningResponse.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "running")
      )
    ...
    IsPodRunningResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.IsPodRunningResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.IsPodExistsRequest = (function () {
    ...
    IsPodExistsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.IsPodExistsRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.IsPodExistsResponse = (function () {
    ...
    IsPodExistsResponse.encode = function encode(message, writer) {
      ...
      if (
        message.exists != null &&
        Object.hasOwnProperty.call(message, "exists")
      )
    ...
    IsPodExistsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.IsPodExistsResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.LogRequest = (function () {
    ...
    LogRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.LogRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.LogResponse = (function () {
    ...
    LogResponse.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.namespace);
      if (
        message.pod_name != null &&
        Object.hasOwnProperty.call(message, "pod_name")
      )
        writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.pod_name);
      if (
        message.container_name != null &&
        Object.hasOwnProperty.call(message, "container_name")
      )
        writer
          .uint32(/* id 3, wireType 2 =*/ 26)
          .string(message.container_name);
    ...
    LogResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.container.LogResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  container.Container = (function () {
     ...
     */
    Object.defineProperty(
      (Container.prototype.copyToPod = function copyToPod(request, callback) {
        return this.rpcCall(
          copyToPod,
          $root.container.CopyToPodRequest,
          $root.container.CopyToPodResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Container.prototype.exec = function exec(request, callback) {
        return this.rpcCall(
          exec,
          $root.container.ExecRequest,
          $root.container.ExecResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Container.prototype.streamCopyToPod = function streamCopyToPod(
        request,
        callback
      ) {
        return this.rpcCall(
          streamCopyToPod,
          $root.container.StreamCopyToPodRequest,
          $root.container.StreamCopyToPodResponse,
          request,
          callback
        );
      }),
      "name",
      { value: "StreamCopyToPod" }
    );
     ...
     */
    Object.defineProperty(
      (Container.prototype.isPodRunning = function isPodRunning(
        request,
        callback
      ) {
        return this.rpcCall(
          isPodRunning,
          $root.container.IsPodRunningRequest,
          $root.container.IsPodRunningResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Container.prototype.isPodExists = function isPodExists(
        request,
        callback
      ) {
        return this.rpcCall(
          isPodExists,
          $root.container.IsPodExistsRequest,
          $root.container.IsPodExistsResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Container.prototype.containerLog = function containerLog(
        request,
        callback
      ) {
        return this.rpcCall(
          containerLog,
          $root.container.LogRequest,
          $root.container.LogResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Container.prototype.streamContainerLog = function streamContainerLog(
        request,
        callback
      ) {
        return this.rpcCall(
...
export const endpoint = ($root.endpoint = (() => {
  ...
  endpoint.InNamespaceRequest = (function () {
     ...
     * @instance
     */
    InNamespaceRequest.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    InNamespaceRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.endpoint.InNamespaceRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  endpoint.InNamespaceResponse = (function () {
    ...
    InNamespaceResponse.encode = function encode(message, writer) {
      ...
      if (message.items != null && message.items.length)
        for (let i = 0; i < message.items.length; ++i)
          $root.types.ServiceEndpoint.encode(
            message.items[i],
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
          ).ldelim();
      return writer;
    ...
    InNamespaceResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.endpoint.InNamespaceResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.ServiceEndpoint.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  endpoint.InProjectRequest = (function () {
     ...
     * @instance
     */
    InProjectRequest.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    InProjectRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.endpoint.InProjectRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  endpoint.InProjectResponse = (function () {
    ...
    InProjectResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.endpoint.InProjectResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  endpoint.Endpoint = (function () {
    ...
    (Endpoint.prototype = Object.create(
      $protobuf.rpc.Service.prototype
     ...
     */
    Object.defineProperty(
      (Endpoint.prototype.inNamespace = function inNamespace(
        request,
        callback
      ) {
        return this.rpcCall(
          inNamespace,
          $root.endpoint.InNamespaceRequest,
          $root.endpoint.InNamespaceResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Endpoint.prototype.inProject = function inProject(request, callback) {
        return this.rpcCall(
          inProject,
          $root.endpoint.InProjectRequest,
          $root.endpoint.InProjectResponse,
          request,
          callback
        );
      }),
...
export const event = ($root.event = (() => {
  ...
  event.ListRequest = (function () {
     ...
     * @instance
     */
    ListRequest.prototype.page = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ListRequest.prototype.page_size = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ListRequest.encode = function encode(message, writer) {
      ...
      if (
        message.page_size != null &&
        Object.hasOwnProperty.call(message, "page_size")
      )
        writer.uint32(/* id 2, wireType 0 =*/ 16).int64(message.page_size);
      if (
        message.action_type != null &&
        Object.hasOwnProperty.call(message, "action_type")
      )
    ...
    ListRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.event.ListRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  event.ListResponse = (function () {
     ...
     * @instance
     */
    ListResponse.prototype.page = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ListResponse.prototype.page_size = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ListResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.event.ListResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 3: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.EventModel.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  event.ShowRequest = (function () {
     ...
     * @instance
     */
    ShowRequest.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ShowRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.event.ShowRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  event.ShowResponse = (function () {
    ...
    ShowResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.event.ShowResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            message.event = $root.types.EventModel.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  event.Event = (function () {
     ...
     */
    Object.defineProperty(
      (Event.prototype.list = function list(request, callback) {
        return this.rpcCall(
          list,
          $root.event.ListRequest,
          $root.event.ListResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Event.prototype.show = function show(request, callback) {
        return this.rpcCall(
          show,
          $root.event.ShowRequest,
          $root.event.ShowResponse,
          request,
          callback
        );
      }),
...
export const file = ($root.file = (() => {
  ...
  file.DeleteRequest = (function () {
     ...
     * @instance
     */
    DeleteRequest.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    DeleteRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.DeleteRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  file.DeleteResponse = (function () {
    ...
    DeleteResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.DeleteResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            message.file = $root.types.FileModel.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  file.DiskInfoRequest = (function () {
    ...
    DiskInfoRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.DiskInfoRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  file.DiskInfoResponse = (function () {
     ...
     * @instance
     */
    DiskInfoResponse.prototype.usage = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    DiskInfoResponse.encode = function encode(message, writer) {
      ...
      if (
        message.humanize_usage != null &&
        Object.hasOwnProperty.call(message, "humanize_usage")
      )
        writer
          .uint32(/* id 2, wireType 2 =*/ 18)
          .string(message.humanize_usage);
      return writer;
    };
    ...
    DiskInfoResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.DiskInfoResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  file.ListRequest = (function () {
    ...
    ListRequest.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 2, wireType 0 =*/ 16).int64(message.page_size);
      if (
        message.without_deleted != null &&
        Object.hasOwnProperty.call(message, "without_deleted")
      )
    ...
    ListRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.ListRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  file.ListResponse = (function () {
     ...
     * @instance
     */
    ListResponse.prototype.count = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ListResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.ListResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 3: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.FileModel.decode(reader, reader.uint32())
            );
            break;
          }
          case 4: {
  ...
  file.MaxUploadSizeRequest = (function () {
    ...
    MaxUploadSizeRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.MaxUploadSizeRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  file.MaxUploadSizeResponse = (function () {
     ...
     * @instance
     */
    MaxUploadSizeResponse.prototype.bytes = $util.Long
    ...
    MaxUploadSizeResponse.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.humanize_size != null &&
        Object.hasOwnProperty.call(message, "humanize_size")
      )
    ...
    MaxUploadSizeResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.MaxUploadSizeResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  file.ShowRecordsRequest = (function () {
     ...
     * @instance
     */
    ShowRecordsRequest.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ShowRecordsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.ShowRecordsRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  file.ShowRecordsResponse = (function () {
    ...
    ShowRecordsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.file.ShowRecordsResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  file.File = (function () {
     ...
     */
    Object.defineProperty(
      (File.prototype.list = function list(request, callback) {
        return this.rpcCall(
          list,
          $root.file.ListRequest,
          $root.file.ListResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (File.prototype.showRecords = function showRecords(request, callback) {
        return this.rpcCall(
          showRecords,
          $root.file.ShowRecordsRequest,
          $root.file.ShowRecordsResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (File.prototype["delete"] = function delete_(request, callback) {
        return this.rpcCall(
          delete_,
          $root.file.DeleteRequest,
          $root.file.DeleteResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (File.prototype.diskInfo = function diskInfo(request, callback) {
        return this.rpcCall(
          diskInfo,
          $root.file.DiskInfoRequest,
          $root.file.DiskInfoResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (File.prototype.maxUploadSize = function maxUploadSize(
        request,
        callback
      ) {
        return this.rpcCall(
          maxUploadSize,
          $root.file.MaxUploadSizeRequest,
          $root.file.MaxUploadSizeResponse,
          request,
          callback
        );
      }),
...
export const git = ($root.git = (() => {
  ...
  git.EnableProjectRequest = (function () {
    ...
    EnableProjectRequest.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.git_project_id != null &&
        Object.hasOwnProperty.call(message, "git_project_id")
      )
        writer
          .uint32(/* id 1, wireType 2 =*/ 10)
          .string(message.git_project_id);
      return writer;
    };
    ...
    EnableProjectRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.EnableProjectRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.DisableProjectRequest = (function () {
    ...
    DisableProjectRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.DisableProjectRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.ProjectItem = (function () {
     ...
     * @instance
     */
    ProjectItem.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ProjectItem.encode = function encode(message, writer) {
      ...
      if (
        message.web_url != null &&
        Object.hasOwnProperty.call(message, "web_url")
      )
        writer.uint32(/* id 4, wireType 2 =*/ 34).string(message.web_url);
      if (
        message.avatar_url != null &&
        Object.hasOwnProperty.call(message, "avatar_url")
      )
      ...
      if (
        message.global_enabled != null &&
        Object.hasOwnProperty.call(message, "global_enabled")
      )
    ...
    ProjectItem.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.ProjectItem();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.AllResponse = (function () {
    ...
    AllResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.AllResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.git.ProjectItem.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  git.Option = (function () {
    ...
    Option.encode = function encode(message, writer) {
      ...
      if (
        message.isLeaf != null &&
        Object.hasOwnProperty.call(message, "isLeaf")
      )
        writer.uint32(/* id 4, wireType 0 =*/ 32).bool(message.isLeaf);
      if (
        message.gitProjectId != null &&
        Object.hasOwnProperty.call(message, "gitProjectId")
      )
        writer.uint32(/* id 5, wireType 2 =*/ 42).string(message.gitProjectId);
      if (
        message.branch != null &&
        Object.hasOwnProperty.call(message, "branch")
      )
        writer.uint32(/* id 6, wireType 2 =*/ 50).string(message.branch);
      if (
        message.display_name != null &&
        Object.hasOwnProperty.call(message, "display_name")
      )
  ...
  git.ProjectOptionsResponse = (function () {
    ...
    ProjectOptionsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.ProjectOptionsResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.git.Option.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  git.BranchOptionsRequest = (function () {
    ...
    BranchOptionsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.BranchOptionsRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.BranchOptionsResponse = (function () {
    ...
    BranchOptionsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.BranchOptionsResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.CommitOptionsRequest = (function () {
    ...
    CommitOptionsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.CommitOptionsRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.CommitOptionsResponse = (function () {
    ...
    CommitOptionsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.CommitOptionsResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.CommitRequest = (function () {
    ...
    CommitRequest.encode = function encode(message, writer) {
      ...
      if (
        message.commit != null &&
        Object.hasOwnProperty.call(message, "commit")
      )
    ...
    CommitRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.CommitRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.CommitResponse = (function () {
    ...
    CommitResponse.encode = function encode(message, writer) {
      ...
      if (message.id != null && Object.hasOwnProperty.call(message, "id"))
        writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.id);
      if (
        message.short_id != null &&
        Object.hasOwnProperty.call(message, "short_id")
      )
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "author_name")
      )
        writer.uint32(/* id 7, wireType 2 =*/ 58).string(message.author_name);
      if (
        message.author_email != null &&
        Object.hasOwnProperty.call(message, "author_email")
      )
        writer.uint32(/* id 8, wireType 2 =*/ 66).string(message.author_email);
      if (
        message.committer_name != null &&
        Object.hasOwnProperty.call(message, "committer_name")
      )
        writer
          .uint32(/* id 9, wireType 2 =*/ 74)
          .string(message.committer_name);
      if (
        message.committer_email != null &&
        Object.hasOwnProperty.call(message, "committer_email")
      )
        writer
          .uint32(/* id 10, wireType 2 =*/ 82)
          .string(message.committer_email);
      if (
        message.web_url != null &&
        Object.hasOwnProperty.call(message, "web_url")
      )
      ...
      if (
        message.committed_date != null &&
        Object.hasOwnProperty.call(message, "committed_date")
      )
        writer
          .uint32(/* id 13, wireType 2 =*/ 106)
          .string(message.committed_date);
      if (
        message.created_at != null &&
        Object.hasOwnProperty.call(message, "created_at")
      )
    ...
    CommitResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.CommitResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.PipelineInfoRequest = (function () {
    ...
    PipelineInfoRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.PipelineInfoRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.PipelineInfoResponse = (function () {
    ...
    PipelineInfoResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.PipelineInfoResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.MarsConfigFileRequest = (function () {
    ...
    MarsConfigFileRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.MarsConfigFileRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  git.MarsConfigFileResponse = (function () {
    ...
    MarsConfigFileResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.MarsConfigFileResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 3: {
            ...
            message.elements.push(
              $root.mars.Element.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  git.EnableProjectResponse = (function () {
    ...
    EnableProjectResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.EnableProjectResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  git.DisableProjectResponse = (function () {
    ...
    DisableProjectResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.DisableProjectResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  git.AllRequest = (function () {
    ...
    AllRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.AllRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  git.ProjectOptionsRequest = (function () {
    ...
    ProjectOptionsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.git.ProjectOptionsRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  git.Git = (function () {
     ...
     */
    Object.defineProperty(
      (Git.prototype.enableProject = function enableProject(request, callback) {
        return this.rpcCall(
          enableProject,
          $root.git.EnableProjectRequest,
          $root.git.EnableProjectResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Git.prototype.disableProject = function disableProject(
        request,
        callback
      ) {
        return this.rpcCall(
          disableProject,
          $root.git.DisableProjectRequest,
          $root.git.DisableProjectResponse,
          request,
          callback
        );
      }),
      "name",
      { value: "DisableProject" }
    );
     ...
     */
    Object.defineProperty(
      (Git.prototype.all = function all(request, callback) {
        return this.rpcCall(
          all,
          $root.git.AllRequest,
          $root.git.AllResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Git.prototype.projectOptions = function projectOptions(
        request,
        callback
      ) {
        return this.rpcCall(
          projectOptions,
          $root.git.ProjectOptionsRequest,
          $root.git.ProjectOptionsResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Git.prototype.branchOptions = function branchOptions(request, callback) {
        return this.rpcCall(
          branchOptions,
          $root.git.BranchOptionsRequest,
          $root.git.BranchOptionsResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Git.prototype.commitOptions = function commitOptions(request, callback) {
        return this.rpcCall(
          commitOptions,
          $root.git.CommitOptionsRequest,
          $root.git.CommitOptionsResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Git.prototype.commit = function commit(request, callback) {
        return this.rpcCall(
          commit,
          $root.git.CommitRequest,
          $root.git.CommitResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Git.prototype.pipelineInfo = function pipelineInfo(request, callback) {
        return this.rpcCall(
          pipelineInfo,
          $root.git.PipelineInfoRequest,
          $root.git.PipelineInfoResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Git.prototype.marsConfigFile = function marsConfigFile(
        request,
        callback
      ) {
        return this.rpcCall(
          marsConfigFile,
          $root.git.MarsConfigFileRequest,
          $root.git.MarsConfigFileResponse,
          request,
          callback
        );
      }),
      "name",
      { value: "MarsConfigFile" }
    );
...
export const gitconfig = ($root.gitconfig = (() => {
  ...
  gitconfig.FileRequest = (function () {
    ...
    FileRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.FileRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.FileResponse = (function () {
    ...
    FileResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.FileResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.ShowRequest = (function () {
     ...
     * @instance
     */
    ShowRequest.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ShowRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.ShowRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.ShowResponse = (function () {
    ...
    ShowResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.ShowResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.GlobalConfigRequest = (function () {
     ...
     * @instance
     */
    GlobalConfigRequest.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    GlobalConfigRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.GlobalConfigRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.GlobalConfigResponse = (function () {
    ...
    GlobalConfigResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.GlobalConfigResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.UpdateRequest = (function () {
     ...
     * @instance
     */
    UpdateRequest.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    UpdateRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.UpdateRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.UpdateResponse = (function () {
    ...
    UpdateResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.UpdateResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.ToggleGlobalStatusRequest = (function () {
     ...
     * @instance
     */
    ToggleGlobalStatusRequest.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ToggleGlobalStatusRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.ToggleGlobalStatusRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.DefaultChartValuesRequest = (function () {
     ...
     * @instance
     */
    DefaultChartValuesRequest.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    DefaultChartValuesRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.DefaultChartValuesRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.DefaultChartValuesResponse = (function () {
    ...
    DefaultChartValuesResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.DefaultChartValuesResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  gitconfig.ToggleGlobalStatusResponse = (function () {
    ...
    ToggleGlobalStatusResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.gitconfig.ToggleGlobalStatusResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  gitconfig.GitConfig = (function () {
    ...
    (GitConfig.prototype = Object.create(
      $protobuf.rpc.Service.prototype
     ...
     */
    Object.defineProperty(
      (GitConfig.prototype.show = function show(request, callback) {
        return this.rpcCall(
          show,
          $root.gitconfig.ShowRequest,
          $root.gitconfig.ShowResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (GitConfig.prototype.globalConfig = function globalConfig(
        request,
        callback
      ) {
        return this.rpcCall(
          globalConfig,
          $root.gitconfig.GlobalConfigRequest,
          $root.gitconfig.GlobalConfigResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (GitConfig.prototype.toggleGlobalStatus = function toggleGlobalStatus(
        request,
        callback
      ) {
        return this.rpcCall(
          toggleGlobalStatus,
          $root.gitconfig.ToggleGlobalStatusRequest,
          $root.gitconfig.ToggleGlobalStatusResponse,
          request,
          callback
        );
      }),
      "name",
      { value: "ToggleGlobalStatus" }
    );
     ...
     */
    Object.defineProperty(
      (GitConfig.prototype.update = function update(request, callback) {
        return this.rpcCall(
          update,
          $root.gitconfig.UpdateRequest,
          $root.gitconfig.UpdateResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (GitConfig.prototype.getDefaultChartValues =
        function getDefaultChartValues(request, callback) {
          return this.rpcCall(
            getDefaultChartValues,
            $root.gitconfig.DefaultChartValuesRequest,
            $root.gitconfig.DefaultChartValuesResponse,
            request,
            callback
          );
        }),
      "name",
      { value: "GetDefaultChartValues" }
    );
...
export const mars = ($root.mars = (() => {
  ...
  mars.Config = (function () {
    ...
    Config.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.config_file != null &&
        Object.hasOwnProperty.call(message, "config_file")
      )
        writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.config_file);
      if (
        message.config_file_values != null &&
        Object.hasOwnProperty.call(message, "config_file_values")
      )
        writer
          .uint32(/* id 2, wireType 2 =*/ 18)
          .string(message.config_file_values);
      if (
        message.config_field != null &&
        Object.hasOwnProperty.call(message, "config_field")
      )
        writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.config_field);
      if (
        message.is_simple_env != null &&
        Object.hasOwnProperty.call(message, "is_simple_env")
      )
        writer.uint32(/* id 4, wireType 0 =*/ 32).bool(message.is_simple_env);
      if (
        message.config_file_type != null &&
        Object.hasOwnProperty.call(message, "config_file_type")
      )
        writer
          .uint32(/* id 5, wireType 2 =*/ 42)
          .string(message.config_file_type);
      if (
        message.local_chart_path != null &&
        Object.hasOwnProperty.call(message, "local_chart_path")
      )
        writer
          .uint32(/* id 6, wireType 2 =*/ 50)
          .string(message.local_chart_path);
      ...
      if (
        message.values_yaml != null &&
        Object.hasOwnProperty.call(message, "values_yaml")
      )
...
export const metrics = ($root.metrics = (() => {
  ...
  metrics.TopPodRequest = (function () {
    ...
    TopPodRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.metrics.TopPodRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  metrics.TopPodResponse = (function () {
     ...
     * @instance
     */
    TopPodResponse.prototype.length = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    TopPodResponse.encode = function encode(message, writer) {
      ...
      if (
        message.memory != null &&
        Object.hasOwnProperty.call(message, "memory")
      )
        writer.uint32(/* id 2, wireType 1 =*/ 17).double(message.memory);
      if (
        message.humanize_cpu != null &&
        Object.hasOwnProperty.call(message, "humanize_cpu")
      )
        writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.humanize_cpu);
      if (
        message.humanize_memory != null &&
        Object.hasOwnProperty.call(message, "humanize_memory")
      )
        writer
          .uint32(/* id 4, wireType 2 =*/ 34)
          .string(message.humanize_memory);
    ...
    TopPodResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.metrics.TopPodResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  metrics.CpuMemoryInNamespaceRequest = (function () {
     ...
     * @instance
     */
    CpuMemoryInNamespaceRequest.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    CpuMemoryInNamespaceRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.metrics.CpuMemoryInNamespaceRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
     ...
     * @returns {string} The default type url
     */
    CpuMemoryInNamespaceRequest.getTypeUrl = function getTypeUrl(
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = "type.googleapis.com";
  ...
  metrics.CpuMemoryInNamespaceResponse = (function () {
    ...
    CpuMemoryInNamespaceResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.metrics.CpuMemoryInNamespaceResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
     ...
     * @returns {string} The default type url
     */
    CpuMemoryInNamespaceResponse.getTypeUrl = function getTypeUrl(
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = "type.googleapis.com";
  ...
  metrics.CpuMemoryInProjectRequest = (function () {
     ...
     * @instance
     */
    CpuMemoryInProjectRequest.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    CpuMemoryInProjectRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.metrics.CpuMemoryInProjectRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  metrics.CpuMemoryInProjectResponse = (function () {
    ...
    CpuMemoryInProjectResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.metrics.CpuMemoryInProjectResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  metrics.Metrics = (function () {
    ...
    (Metrics.prototype = Object.create(
      $protobuf.rpc.Service.prototype
    )).constructor = Metrics;
     ...
     */
    Object.defineProperty(
      (Metrics.prototype.cpuMemoryInNamespace = function cpuMemoryInNamespace(
        request,
        callback
      ) {
        return this.rpcCall(
          cpuMemoryInNamespace,
          $root.metrics.CpuMemoryInNamespaceRequest,
          $root.metrics.CpuMemoryInNamespaceResponse,
          request,
          callback
        );
      }),
      "name",
      { value: "CpuMemoryInNamespace" }
    );
     ...
     */
    Object.defineProperty(
      (Metrics.prototype.cpuMemoryInProject = function cpuMemoryInProject(
        request,
        callback
      ) {
        return this.rpcCall(
          cpuMemoryInProject,
          $root.metrics.CpuMemoryInProjectRequest,
          $root.metrics.CpuMemoryInProjectResponse,
          request,
          callback
        );
      }),
      "name",
      { value: "CpuMemoryInProject" }
    );
     ...
     */
    Object.defineProperty(
      (Metrics.prototype.topPod = function topPod(request, callback) {
        return this.rpcCall(
          topPod,
          $root.metrics.TopPodRequest,
          $root.metrics.TopPodResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Metrics.prototype.streamTopPod = function streamTopPod(
        request,
        callback
      ) {
        return this.rpcCall(
...
export const namespace = ($root.namespace = (() => {
  ...
  namespace.CreateRequest = (function () {
    ...
    CreateRequest.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.namespace);
      if (
        message.ignore_if_exists != null &&
        Object.hasOwnProperty.call(message, "ignore_if_exists")
      )
        writer
          .uint32(/* id 2, wireType 0 =*/ 16)
          .bool(message.ignore_if_exists);
      return writer;
    };
    ...
    CreateRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.CreateRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  namespace.ShowRequest = (function () {
     ...
     * @instance
     */
    ShowRequest.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ShowRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.ShowRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  namespace.DeleteRequest = (function () {
     ...
     * @instance
     */
    DeleteRequest.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    DeleteRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.DeleteRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  namespace.IsExistsRequest = (function () {
    ...
    IsExistsRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.IsExistsRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  namespace.AllResponse = (function () {
    ...
    AllResponse.encode = function encode(message, writer) {
      ...
      if (message.items != null && message.items.length)
        for (let i = 0; i < message.items.length; ++i)
          $root.types.NamespaceModel.encode(
            message.items[i],
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
          ).ldelim();
      return writer;
    ...
    AllResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.AllResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.NamespaceModel.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  namespace.CreateResponse = (function () {
    ...
    CreateResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.CreateResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            message.namespace = $root.types.NamespaceModel.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  namespace.ShowResponse = (function () {
    ...
    ShowResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.ShowResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  namespace.IsExistsResponse = (function () {
     ...
     * @instance
     */
    IsExistsResponse.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    IsExistsResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.IsExistsResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  namespace.AllRequest = (function () {
    ...
    AllRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.AllRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  namespace.DeleteResponse = (function () {
    ...
    DeleteResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namespace.DeleteResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  namespace.Namespace = (function () {
     ...
     */
    Object.defineProperty(
      (Namespace.prototype.all = function all(request, callback) {
        return this.rpcCall(
          all,
          $root.namespace.AllRequest,
          $root.namespace.AllResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Namespace.prototype.create = function create(request, callback) {
        return this.rpcCall(
          create,
          $root.namespace.CreateRequest,
          $root.namespace.CreateResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Namespace.prototype.show = function show(request, callback) {
        return this.rpcCall(
          show,
          $root.namespace.ShowRequest,
          $root.namespace.ShowResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Namespace.prototype["delete"] = function delete_(request, callback) {
        return this.rpcCall(
          delete_,
          $root.namespace.DeleteRequest,
          $root.namespace.DeleteResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Namespace.prototype.isExists = function isExists(request, callback) {
        return this.rpcCall(
          isExists,
          $root.namespace.IsExistsRequest,
          $root.namespace.IsExistsResponse,
          request,
          callback
        );
      }),
...
export const picture = ($root.picture = (() => {
  ...
  picture.BackgroundRequest = (function () {
    ...
    BackgroundRequest.encode = function encode(message, writer) {
      ...
      if (
        message.random != null &&
        Object.hasOwnProperty.call(message, "random")
      )
    ...
    BackgroundRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.picture.BackgroundRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  picture.BackgroundResponse = (function () {
    ...
    BackgroundResponse.encode = function encode(message, writer) {
      ...
      if (
        message.copyright != null &&
        Object.hasOwnProperty.call(message, "copyright")
      )
    ...
    BackgroundResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.picture.BackgroundResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  picture.Picture = (function () {
    ...
    (Picture.prototype = Object.create(
      $protobuf.rpc.Service.prototype
    )).constructor = Picture;
     ...
     */
    Object.defineProperty(
      (Picture.prototype.background = function background(request, callback) {
        return this.rpcCall(
          background,
          $root.picture.BackgroundRequest,
          $root.picture.BackgroundResponse,
          request,
          callback
        );
      }),
...
export const project = ($root.project = (() => {
  ...
  project.DeleteRequest = (function () {
     ...
     * @instance
     */
    DeleteRequest.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    DeleteRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.DeleteRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.ShowRequest = (function () {
    ...
    ShowRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.ShowRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.ShowResponse = (function () {
    ...
    ShowResponse.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "project")
      )
        $root.types.ProjectModel.encode(
          message.project,
          writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
        ).ldelim();
    ...
    ShowResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.ShowResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            message.project = $root.types.ProjectModel.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  project.AllContainersRequest = (function () {
     ...
     * @instance
     */
    AllContainersRequest.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    AllContainersRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.AllContainersRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.AllContainersResponse = (function () {
    ...
    AllContainersResponse.encode = function encode(message, writer) {
      ...
      if (message.items != null && message.items.length)
        for (let i = 0; i < message.items.length; ++i)
          $root.types.StateContainer.encode(
            message.items[i],
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork()
          ).ldelim();
      return writer;
    ...
    AllContainersResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.AllContainersResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.StateContainer.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  project.ApplyResponse = (function () {
    ...
    ApplyResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.ApplyResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.DryRunApplyResponse = (function () {
    ...
    DryRunApplyResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.DryRunApplyResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.ApplyRequest = (function () {
     ...
     * @instance
     */
    ApplyRequest.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ApplyRequest.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ApplyRequest.prototype.install_timeout_seconds = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ApplyRequest.encode = function encode(message, writer) {
      ...
      if (
        message.git_branch != null &&
        Object.hasOwnProperty.call(message, "git_branch")
      )
        writer.uint32(/* id 4, wireType 2 =*/ 34).string(message.git_branch);
      if (
        message.git_commit != null &&
        Object.hasOwnProperty.call(message, "git_commit")
      )
      ...
      if (
        message.atomic != null &&
        Object.hasOwnProperty.call(message, "atomic")
      )
        writer.uint32(/* id 7, wireType 0 =*/ 56).bool(message.atomic);
      if (
        message.websocket_sync != null &&
        Object.hasOwnProperty.call(message, "websocket_sync")
      )
      ...
      if (message.extra_values != null && message.extra_values.length)
        for (let i = 0; i < message.extra_values.length; ++i)
          $root.types.ExtraValue.encode(
            message.extra_values[i],
            writer.uint32(/* id 9, wireType 2 =*/ 74).fork()
          ).ldelim();
      if (
        message.install_timeout_seconds != null &&
        Object.hasOwnProperty.call(message, "install_timeout_seconds")
      )
        writer
          .uint32(/* id 10, wireType 0 =*/ 80)
          .int64(message.install_timeout_seconds);
      if (
        message.send_percent != null &&
    ...
    ApplyRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.ApplyRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.DeleteResponse = (function () {
    ...
    DeleteResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.DeleteResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  project.ListRequest = (function () {
    ...
    ListRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.ListRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.ListResponse = (function () {
    ...
    ListResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.ListResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 4: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.ProjectModel.decode(reader, reader.uint32())
            );
            break;
          }
          default:
  ...
  project.HostVariablesRequest = (function () {
     ...
     * @instance
     */
    HostVariablesRequest.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    HostVariablesRequest.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.project_name != null &&
        Object.hasOwnProperty.call(message, "project_name")
      )
    ...
    HostVariablesRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.HostVariablesRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  project.HostVariablesResponse = (function () {
    ...
    HostVariablesResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.project.HostVariablesResponse(),
        key,
        value;
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            if (message.hosts === $util.emptyObject) message.hosts = {};
  ...
  project.Project = (function () {
    ...
    (Project.prototype = Object.create(
      $protobuf.rpc.Service.prototype
    )).constructor = Project;
     ...
     */
    Object.defineProperty(
      (Project.prototype.list = function list(request, callback) {
        return this.rpcCall(
          list,
          $root.project.ListRequest,
          $root.project.ListResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Project.prototype.apply = function apply(request, callback) {
        return this.rpcCall(
          apply,
          $root.project.ApplyRequest,
          $root.project.ApplyResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Project.prototype.applyDryRun = function applyDryRun(request, callback) {
        return this.rpcCall(
          applyDryRun,
          $root.project.ApplyRequest,
          $root.project.DryRunApplyResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Project.prototype.show = function show(request, callback) {
        return this.rpcCall(
          show,
          $root.project.ShowRequest,
          $root.project.ShowResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Project.prototype["delete"] = function delete_(request, callback) {
        return this.rpcCall(
          delete_,
          $root.project.DeleteRequest,
          $root.project.DeleteResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Project.prototype.allContainers = function allContainers(
        request,
        callback
      ) {
        return this.rpcCall(
          allContainers,
          $root.project.AllContainersRequest,
          $root.project.AllContainersResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (Project.prototype.hostVariables = function hostVariables(
        request,
        callback
      ) {
        return this.rpcCall(
          hostVariables,
          $root.project.HostVariablesRequest,
          $root.project.HostVariablesResponse,
          request,
          callback
        );
      }),
...
export const token = ($root.token = (() => {
  ...
  token.ListRequest = (function () {
    ...
    ListRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.ListRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  token.ListResponse = (function () {
    ...
    ListResponse.encode = function encode(message, writer) {
      ...
      if (message.items != null && message.items.length)
        for (let i = 0; i < message.items.length; ++i)
          $root.types.AccessTokenModel.encode(
            message.items[i],
            writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
          ).ldelim();
      if (message.count != null && Object.hasOwnProperty.call(message, "count"))
    ...
    ListResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.ListResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 3: {
            if (!(message.items && message.items.length)) message.items = [];
            message.items.push(
              $root.types.AccessTokenModel.decode(reader, reader.uint32())
            );
            break;
          }
          case 4: {
  ...
  token.GrantRequest = (function () {
     ...
     * @instance
     */
    GrantRequest.prototype.expire_seconds = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    GrantRequest.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (
        message.expire_seconds != null &&
        Object.hasOwnProperty.call(message, "expire_seconds")
      )
    ...
    GrantRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.GrantRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  token.GrantResponse = (function () {
    ...
    GrantResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.GrantResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
            message.token = $root.types.AccessTokenModel.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  token.LeaseRequest = (function () {
     ...
     * @instance
     */
    LeaseRequest.prototype.expire_seconds = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    LeaseRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.LeaseRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  token.LeaseResponse = (function () {
    ...
    LeaseResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.LeaseResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  token.RevokeRequest = (function () {
    ...
    RevokeRequest.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.RevokeRequest();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  token.RevokeResponse = (function () {
    ...
    RevokeResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.token.RevokeResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  token.AccessToken = (function () {
    ...
    (AccessToken.prototype = Object.create(
      $protobuf.rpc.Service.prototype
     ...
     */
    Object.defineProperty(
      (AccessToken.prototype.list = function list(request, callback) {
        return this.rpcCall(
          list,
          $root.token.ListRequest,
          $root.token.ListResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (AccessToken.prototype.grant = function grant(request, callback) {
        return this.rpcCall(
          grant,
          $root.token.GrantRequest,
          $root.token.GrantResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (AccessToken.prototype.lease = function lease(request, callback) {
        return this.rpcCall(
          lease,
          $root.token.LeaseRequest,
          $root.token.LeaseResponse,
          request,
          callback
        );
      }),
     ...
     */
    Object.defineProperty(
      (AccessToken.prototype.revoke = function revoke(request, callback) {
        return this.rpcCall(
          revoke,
          $root.token.RevokeRequest,
          $root.token.RevokeResponse,
          request,
          callback
        );
      }),
...
export const types = ($root.types = (() => {
  ...
  types.Container = (function () {
    ...
    Container.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.Container();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.StateContainer = (function () {
    ...
    StateContainer.encode = function encode(message, writer) {
      ...
      if (
        message.is_old != null &&
        Object.hasOwnProperty.call(message, "is_old")
      )
        writer.uint32(/* id 4, wireType 0 =*/ 32).bool(message.is_old);
      if (
        message.terminating != null &&
        Object.hasOwnProperty.call(message, "terminating")
      )
        writer.uint32(/* id 5, wireType 0 =*/ 40).bool(message.terminating);
      if (
        message.pending != null &&
        Object.hasOwnProperty.call(message, "pending")
      )
    ...
    StateContainer.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.StateContainer();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.ExtraValue = (function () {
    ...
    ExtraValue.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.ExtraValue();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.ServiceEndpoint = (function () {
    ...
    ServiceEndpoint.encode = function encode(message, writer) {
      ...
      if (
        message.port_name != null &&
        Object.hasOwnProperty.call(message, "port_name")
      )
    ...
    ServiceEndpoint.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.ServiceEndpoint();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.ChangelogModel = (function () {
     ...
     * @instance
     */
    ChangelogModel.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ChangelogModel.prototype.version = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ChangelogModel.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ChangelogModel.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ChangelogModel.encode = function encode(message, writer) {
      ...
      if (
        message.config_changed != null &&
        Object.hasOwnProperty.call(message, "config_changed")
      )
      ...
      if (
        message.git_project != null &&
        Object.hasOwnProperty.call(message, "git_project")
      )
        $root.types.GitProjectModel.encode(
          message.git_project,
      ...
      if (
        message.config_type != null &&
        Object.hasOwnProperty.call(message, "config_type")
      )
      ...
      if (
        message.docker_image != null &&
        Object.hasOwnProperty.call(message, "docker_image")
      )
        writer
          .uint32(/* id 15, wireType 2 =*/ 122)
          .string(message.docker_image);
      if (
        message.env_values != null &&
        Object.hasOwnProperty.call(message, "env_values")
      )
        writer.uint32(/* id 16, wireType 2 =*/ 130).string(message.env_values);
      if (
        message.extra_values != null &&
        Object.hasOwnProperty.call(message, "extra_values")
      )
        writer
          .uint32(/* id 17, wireType 2 =*/ 138)
          .string(message.extra_values);
      if (
        message.final_extra_values != null &&
        Object.hasOwnProperty.call(message, "final_extra_values")
      )
        writer
          .uint32(/* id 18, wireType 2 =*/ 146)
          .string(message.final_extra_values);
      if (
        message.git_commit_web_url != null &&
        Object.hasOwnProperty.call(message, "git_commit_web_url")
      )
        writer
          .uint32(/* id 19, wireType 2 =*/ 154)
          .string(message.git_commit_web_url);
      if (
        message.git_commit_title != null &&
        Object.hasOwnProperty.call(message, "git_commit_title")
      )
        writer
          .uint32(/* id 20, wireType 2 =*/ 162)
          .string(message.git_commit_title);
      if (
        message.git_commit_author != null &&
        Object.hasOwnProperty.call(message, "git_commit_author")
      )
        writer
          .uint32(/* id 21, wireType 2 =*/ 170)
          .string(message.git_commit_author);
      if (
        message.git_commit_date != null &&
        Object.hasOwnProperty.call(message, "git_commit_date")
      )
        writer
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "updated_at")
      )
        writer.uint32(/* id 101, wireType 2 =*/ 810).string(message.updated_at);
      if (
        message.deleted_at != null &&
        Object.hasOwnProperty.call(message, "deleted_at")
      )
    ...
    ChangelogModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.ChangelogModel();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 10: {
            message.git_project = $root.types.GitProjectModel.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  types.EventModel = (function () {
     ...
     * @instance
     */
    EventModel.prototype.file_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    EventModel.encode = function encode(message, writer) {
      ...
      if (
        message.event_at != null &&
        Object.hasOwnProperty.call(message, "event_at")
      )
        writer.uint32(/* id 10, wireType 2 =*/ 82).string(message.event_at);
      if (
        message.has_diff != null &&
        Object.hasOwnProperty.call(message, "has_diff")
      )
    ...
    EventModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.EventModel();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.FileModel = (function () {
     ...
     * @instance
     */
    FileModel.prototype.size = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    FileModel.encode = function encode(message, writer) {
      ...
      if (
        message.container_Path != null &&
        Object.hasOwnProperty.call(message, "container_Path")
      )
        writer
          .uint32(/* id 8, wireType 2 =*/ 66)
          .string(message.container_Path);
      if (
        message.humanize_size != null &&
        Object.hasOwnProperty.call(message, "humanize_size")
      )
    ...
    FileModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.FileModel();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.GitProjectModel = (function () {
     ...
     * @instance
     */
    GitProjectModel.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    GitProjectModel.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    GitProjectModel.encode = function encode(message, writer) {
      ...
      if (message.id != null && Object.hasOwnProperty.call(message, "id"))
        writer.uint32(/* id 1, wireType 0 =*/ 8).int64(message.id);
      if (
        message.default_branch != null &&
        Object.hasOwnProperty.call(message, "default_branch")
      )
        writer
          .uint32(/* id 2, wireType 2 =*/ 18)
          .string(message.default_branch);
      if (message.name != null && Object.hasOwnProperty.call(message, "name"))
        writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.name);
      if (
        message.git_project_id != null &&
      ...
      if (
        message.global_config != null &&
        Object.hasOwnProperty.call(message, "global_config")
      )
    ...
    GitProjectModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.GitProjectModel();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.ImagePullSecret = (function () {
    ...
    ImagePullSecret.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.ImagePullSecret();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.NamespaceModel = (function () {
     ...
     * @instance
     */
    NamespaceModel.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    NamespaceModel.encode = function encode(message, writer) {
      ...
      if (message.ImagePullSecrets != null && message.ImagePullSecrets.length)
        for (let i = 0; i < message.ImagePullSecrets.length; ++i)
          $root.types.ImagePullSecret.encode(
            message.ImagePullSecrets[i],
            writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
          ).ldelim();
    ...
    NamespaceModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.NamespaceModel();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 3: {
            ...
            message.ImagePullSecrets.push(
              $root.types.ImagePullSecret.decode(reader, reader.uint32())
            );
            break;
          }
          case 4: {
  ...
  types.ProjectModel = (function () {
     ...
     * @instance
     */
    ProjectModel.prototype.id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ProjectModel.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ProjectModel.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ProjectModel.encode = function encode(message, writer) {
      ...
      if (
        ...
        writer.uint32(/* id 6, wireType 2 =*/ 50).string(message.config);
      if (
        message.override_values != null &&
        Object.hasOwnProperty.call(message, "override_values")
      )
        writer
          .uint32(/* id 7, wireType 2 =*/ 58)
          .string(message.override_values);
      if (
        message.docker_image != null &&
        Object.hasOwnProperty.call(message, "docker_image")
      )
      ...
      if (
        message.pod_selectors != null &&
        Object.hasOwnProperty.call(message, "pod_selectors")
      )
      ...
      if (
        ...
        writer
          ...
          .string(message.final_extra_values);
      if (
        message.deploy_status != null &&
        Object.hasOwnProperty.call(message, "deploy_status")
      )
        writer
          .uint32(/* id 15, wireType 0 =*/ 120)
          .int32(message.deploy_status);
      if (
        message.humanize_created_at != null &&
        Object.hasOwnProperty.call(message, "humanize_created_at")
      )
        writer
          .uint32(/* id 16, wireType 2 =*/ 130)
          .string(message.humanize_created_at);
      if (
        message.humanize_updated_at != null &&
        Object.hasOwnProperty.call(message, "humanize_updated_at")
      )
        writer
          .uint32(/* id 17, wireType 2 =*/ 138)
          .string(message.humanize_updated_at);
      if (
        message.config_type != null &&
        Object.hasOwnProperty.call(message, "config_type")
      )
    ...
    ProjectModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.ProjectModel();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  types.AccessTokenModel = (function () {
    ...
    AccessTokenModel.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.types.AccessTokenModel();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
...
export const version = ($root.version = (() => {
  ...
  version.Request = (function () {
    ...
    Request.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.version.Request();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  version.Response = (function () {
    ...
    Response.encode = function encode(message, writer) {
      ...
      if (
        message.build_date != null &&
        Object.hasOwnProperty.call(message, "build_date")
      )
      ...
      if (
        message.git_tag != null &&
        Object.hasOwnProperty.call(message, "git_tag")
      )
        writer.uint32(/* id 5, wireType 2 =*/ 42).string(message.git_tag);
      if (
        message.go_version != null &&
        Object.hasOwnProperty.call(message, "go_version")
      )
        writer.uint32(/* id 6, wireType 2 =*/ 50).string(message.go_version);
      if (
        message.compiler != null &&
        Object.hasOwnProperty.call(message, "compiler")
      )
      ...
      if (
        message.kubectl_version != null &&
        Object.hasOwnProperty.call(message, "kubectl_version")
      )
        writer
          .uint32(/* id 9, wireType 2 =*/ 74)
          .string(message.kubectl_version);
      if (
        message.helm_version != null &&
        Object.hasOwnProperty.call(message, "helm_version")
      )
        writer.uint32(/* id 10, wireType 2 =*/ 82).string(message.helm_version);
      if (
        message.git_repo != null &&
        Object.hasOwnProperty.call(message, "git_repo")
      )
    ...
    Response.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.version.Response();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  version.Version = (function () {
    ...
    Object.defineProperty(
      (Version.prototype.version = function version(request, callback) {
        return this.rpcCall(
          version,
          $root.version.Request,
          $root.version.Response,
          request,
          callback
        );
      }),
...
export const websocket = ($root.websocket = (() => {
  ...
  websocket.WsRequestMetadata = (function () {
    ...
    WsRequestMetadata.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.WsRequestMetadata();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.AuthorizeTokenInput = (function () {
    ...
    AuthorizeTokenInput.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.AuthorizeTokenInput();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.TerminalMessage = (function () {
    ...
    TerminalMessage.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.TerminalMessage();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.ProjectPodEventJoinInput = (function () {
     ...
     * @instance
     */
    ProjectPodEventJoinInput.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    ProjectPodEventJoinInput.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    ProjectPodEventJoinInput.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.ProjectPodEventJoinInput();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.TerminalMessageInput = (function () {
    ...
    TerminalMessageInput.encode = function encode(message, writer) {
      ...
      if (
        ...
        $root.websocket.TerminalMessage.encode(
          message.message,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
        ).ldelim();
      return writer;
    ...
    TerminalMessageInput.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.TerminalMessageInput();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            message.message = $root.websocket.TerminalMessage.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  websocket.WsHandleExecShellInput = (function () {
    ...
    WsHandleExecShellInput.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.WsHandleExecShellInput();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            message.container = $root.types.Container.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  websocket.CancelInput = (function () {
     ...
     * @instance
     */
    CancelInput.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    CancelInput.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.CancelInput();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.CreateProjectInput = (function () {
     ...
     * @instance
     */
    CreateProjectInput.prototype.namespace_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
     ...
     * @instance
     */
    CreateProjectInput.prototype.git_project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    CreateProjectInput.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.CreateProjectInput();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.UpdateProjectInput = (function () {
     ...
     * @instance
     */
    UpdateProjectInput.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    UpdateProjectInput.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.UpdateProjectInput();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.Metadata = (function () {
     ...
     * @instance
     */
    Metadata.prototype.percent = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    Metadata.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "percent")
      )
    ...
    Metadata.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.Metadata();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.WsMetadataResponse = (function () {
    ...
    WsMetadataResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.WsMetadataResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.WsHandleShellResponse = (function () {
    ...
    WsHandleShellResponse.encode = function encode(message, writer) {
      ...
      if (
        message.terminal_message != null &&
        Object.hasOwnProperty.call(message, "terminal_message")
      )
        $root.websocket.TerminalMessage.encode(
    ...
    WsHandleShellResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.WsHandleShellResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            message.terminal_message = $root.websocket.TerminalMessage.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  websocket.WsHandleClusterResponse = (function () {
    ...
    WsHandleClusterResponse.encode = function encode(message, writer) {
      ...
      if (message.info != null && Object.hasOwnProperty.call(message, "info"))
        $root.cluster.InfoResponse.encode(
          message.info,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
        ).ldelim();
      return writer;
    ...
    WsHandleClusterResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.WsHandleClusterResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            message.info = $root.cluster.InfoResponse.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  websocket.WsWithContainerMessageResponse = (function () {
    ...
    WsWithContainerMessageResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.WsWithContainerMessageResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
          ...
          case 2: {
            ...
            message.containers.push(
              $root.types.Container.decode(reader, reader.uint32())
            );
            break;
          }
          default:
     ...
     * @returns {string} The default type url
     */
    WsWithContainerMessageResponse.getTypeUrl = function getTypeUrl(
      typeUrlPrefix
    ) {
      if (typeUrlPrefix === undefined) {
        typeUrlPrefix = "type.googleapis.com";
  ...
  websocket.WsProjectPodEventResponse = (function () {
     ...
     * @instance
     */
    WsProjectPodEventResponse.prototype.project_id = $util.Long
      ? $util.Long.fromBits(0, 0, false)
      : 0;
    ...
    WsProjectPodEventResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.WsProjectPodEventResponse();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
