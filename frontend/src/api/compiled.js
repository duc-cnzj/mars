...
export const mars = $root.mars = (() => {
     ...
     * @property {number} ElementTypeNumberSelect=7 ElementTypeNumberSelect value
     * @property {number} ElementTypeNumberRadio=8 ElementTypeNumberRadio value
     */
    mars.ElementType = (function() {
        ...
        values[valuesById[7] = "ElementTypeNumberSelect"] = 7;
        values[valuesById[8] = "ElementTypeNumberRadio"] = 8;
        return values;
    })();
...
export const project = $root.project = (() => {
    ...
    project.VersionRequest = (function() {
         ...
         * @instance
         */
        VersionRequest.prototype.project_id = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        VersionRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.project.VersionRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    project.VersionResponse = (function() {
         ...
         * @instance
         */
        VersionResponse.prototype.version = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        VersionResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.project.VersionResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
    ...
    project.Project = (function() {
         ...
         * @variation 1
         */
        Object.defineProperty(Project.prototype.version = function version(request, callback) {
            return this.rpcCall(version, $root.project.VersionRequest, $root.project.VersionResponse, request, callback);
        }, "name", { value: "Version" });
...
export const types = $root.types = (() => {
     ...
     * @property {number} Exec=10 Exec value
     */
    ...
    types.ProjectModel = (function() {
         ...
         * @instance
         */
        ProjectModel.prototype.version = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
...
export const websocket = $root.websocket = (() => {
    ...
    websocket.UpdateProjectInput = (function() {
         ...
         * @instance
         */
        UpdateProjectInput.prototype.version = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
    ...
    websocket.WsReloadProjectsResponse = (function() {
         ...
         * @instance
         */
        WsReloadProjectsResponse.prototype.namespace_id = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
