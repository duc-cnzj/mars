...
export const websocket = ($root.websocket = (() => {
  ...
  websocket.ClusterInfo = (function () {
    ...
    ClusterInfo.encode = function encode(message, writer) {
      ...
      if (
        message.freeMemory != null &&
        Object.hasOwnProperty.call(message, "freeMemory")
      )
        writer.uint32(/* id 2, wireType 2 =*/ 18).string(message.freeMemory);
      if (
        message.freeCpu != null &&
        Object.hasOwnProperty.call(message, "freeCpu")
      )
        writer.uint32(/* id 3, wireType 2 =*/ 26).string(message.freeCpu);
      if (
        message.freeRequestMemory != null &&
        Object.hasOwnProperty.call(message, "freeRequestMemory")
      )
        writer
          .uint32(/* id 4, wireType 2 =*/ 34)
          .string(message.freeRequestMemory);
      if (
        message.freeRequestCpu != null &&
        Object.hasOwnProperty.call(message, "freeRequestCpu")
      )
        writer
          .uint32(/* id 5, wireType 2 =*/ 42)
          .string(message.freeRequestCpu);
      if (
        message.totalMemory != null &&
        Object.hasOwnProperty.call(message, "totalMemory")
      )
        writer.uint32(/* id 6, wireType 2 =*/ 50).string(message.totalMemory);
      if (
        message.totalCpu != null &&
        Object.hasOwnProperty.call(message, "totalCpu")
      )
        writer.uint32(/* id 7, wireType 2 =*/ 58).string(message.totalCpu);
      if (
        message.usageMemoryRate != null &&
        Object.hasOwnProperty.call(message, "usageMemoryRate")
      )
        writer
          .uint32(/* id 8, wireType 2 =*/ 66)
          .string(message.usageMemoryRate);
      if (
        message.usageCpuRate != null &&
        Object.hasOwnProperty.call(message, "usageCpuRate")
      )
        writer.uint32(/* id 9, wireType 2 =*/ 74).string(message.usageCpuRate);
      if (
        message.requestMemoryRate != null &&
        Object.hasOwnProperty.call(message, "requestMemoryRate")
      )
        writer
          .uint32(/* id 10, wireType 2 =*/ 82)
          .string(message.requestMemoryRate);
      if (
        message.requestCpuRate != null &&
        Object.hasOwnProperty.call(message, "requestCpuRate")
      )
        writer
          .uint32(/* id 11, wireType 2 =*/ 90)
          .string(message.requestCpuRate);
      return writer;
    };
    ...
    ClusterInfo.decode = function decode(reader, length) {
      ...
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.ClusterInfo();
  ...
  websocket.ExtraValue = (function () {
    ...
    ExtraValue.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.ExtraValue();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.Container = (function () {
    ...
    Container.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      let end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.websocket.Container();
      while (reader.pos < end) {
        let tag = reader.uint32();
        switch (tag >>> 3) {
          case 1: {
  ...
  websocket.ProjectPodEventJoinInput = (function () {
    ...
    ProjectPodEventJoinInput.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "projectId")
      )
        writer.uint32(/* id 3, wireType 0 =*/ 24).int32(message.projectId);
      if (
        message.namespaceId != null &&
        Object.hasOwnProperty.call(message, "namespaceId")
      )
  ...
  websocket.WsHandleExecShellInput = (function () {
    ...
    WsHandleExecShellInput.encode = function encode(message, writer) {
      ...
      if (
        ...
        $root.websocket.Container.encode(
          message.container,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
        ).ldelim();
      if (
    ...
    WsHandleExecShellInput.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            message.container = $root.websocket.Container.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  websocket.CreateProjectInput = (function () {
    ...
    /**
     * CreateProjectInput _atomic.
     * @member {"atomic"|undefined} _atomic
     * @memberof websocket.CreateProjectInput
     * @instance
     */
    ...
    CreateProjectInput.encode = function encode(message, writer) {
      ...
      if (
        message.repoId != null &&
        Object.hasOwnProperty.call(message, "repoId")
      )
        writer.uint32(/* id 4, wireType 0 =*/ 32).int32(message.repoId);
      if (
        message.gitBranch != null &&
        Object.hasOwnProperty.call(message, "gitBranch")
      )
        writer.uint32(/* id 5, wireType 2 =*/ 42).string(message.gitBranch);
      if (
        message.gitCommit != null &&
        Object.hasOwnProperty.call(message, "gitCommit")
      )
      ...
      if (message.extraValues != null && message.extraValues.length)
        for (let i = 0; i < message.extraValues.length; ++i)
          $root.websocket.ExtraValue.encode(
            message.extraValues[i],
        ...
        switch (tag >>> 3) {
          ...
          case 8: {
            if (!(message.extraValues && message.extraValues.length))
              message.extraValues = [];
            message.extraValues.push(
              $root.websocket.ExtraValue.decode(reader, reader.uint32())
            );
            break;
          }
          case 9: {
  ...
  websocket.WsHandleShellResponse = (function () {
    ...
    WsHandleShellResponse.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "terminalMessage")
      )
        $root.websocket.TerminalMessage.encode(
    ...
    WsHandleShellResponse.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            message.terminalMessage = $root.websocket.TerminalMessage.decode(
              reader,
              reader.uint32()
            );
            break;
  ...
  websocket.WsHandleClusterResponse = (function () {
    ...
    WsHandleClusterResponse.encode = function encode(message, writer) {
      ...
      if (message.info != null && Object.hasOwnProperty.call(message, "info"))
        $root.websocket.ClusterInfo.encode(
          message.info,
          writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
        ).ldelim();
      return writer;
    ...
    WsHandleClusterResponse.decode = function decode(reader, length) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            message.info = $root.websocket.ClusterInfo.decode(
              reader,
              reader.uint32()
            );
            break;
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.containers.push(
              $root.websocket.Container.decode(reader, reader.uint32())
            );
            break;
          }
          default:
