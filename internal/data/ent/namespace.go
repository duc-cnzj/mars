	...
	for i := range columns {
		...
		case namespace.FieldImagePullSecrets:
			if value, ok := values[i].(*[]byte); !ok {
				...
				if err := json.Unmarshal(*value, &_m.ImagePullSecrets); err != nil {
...
func (_m *Namespace) QueryFavorites() *FavoriteQuery {
	return NewNamespaceClient(_m.config).QueryFavorites(_m)
}

// QueryMembers queries the "members" edge of the Namespace entity.
func (_m *Namespace) QueryMembers() *MemberQuery {
	return NewNamespaceClient(_m.config).QueryMembers(_m)
}
...
func (_m *Namespace) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.ImagePullSecrets))
	builder.WriteString(", ")
