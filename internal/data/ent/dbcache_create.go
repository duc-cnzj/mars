...
func (_c *DBCacheCreate) SetKey(v string) *DBCacheCreate {
	_c.mutation.SetKey(v)
	return _c
}

// SetValue sets the "value" field.
func (_c *DBCacheCreate) SetValue(v string) *DBCacheCreate {
	_c.mutation.SetValue(v)
	return _c
}

// SetNillableValue sets the "value" field if the given value is not nil.
func (_c *DBCacheCreate) SetNillableValue(v *string) *DBCacheCreate {
	if v != nil {
		_c.SetValue(*v)
	}
	return _c
...
func (_c *DBCacheCreate) SetExpiredAt(v time.Time) *DBCacheCreate {
	_c.mutation.SetExpiredAt(v)
	return _c
}

// SetNillableExpiredAt sets the "expired_at" field if the given value is not nil.
func (_c *DBCacheCreate) SetNillableExpiredAt(v *time.Time) *DBCacheCreate {
	if v != nil {
		_c.SetExpiredAt(*v)
	}
	return _c
...
func (_c *DBCacheCreate) Mutation() *DBCacheMutation {
	return _c.mutation
}

// Save creates the DBCache in the database.
func (_c *DBCacheCreate) Save(ctx context.Context) (*DBCache, error) {
	return withHooks(ctx, _c.sqlSave, _c.mutation, _c.hooks)
}

// SaveX calls Save and panics if Save returns an error.
func (_c *DBCacheCreate) SaveX(ctx context.Context) *DBCache {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (_c *DBCacheCreate) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *DBCacheCreate) ExecX(ctx context.Context) {
...
func (_c *DBCacheCreate) check() error {
...
func (_c *DBCacheCreate) sqlSave(ctx context.Context) (*DBCache, error) {
...
func (_c *DBCacheCreate) createSpec() (*DBCache, *sqlgraph.CreateSpec) {
	var (
		_node = &DBCache{config: _c.config}
...
//		}).
//		Exec(ctx)
func (_c *DBCacheCreate) OnConflict(opts ...sql.ConflictOption) *DBCacheUpsertOne {
	_c.conflict = opts
...
//		Exec(ctx)
func (_c *DBCacheCreate) OnConflictColumns(columns ...string) *DBCacheUpsertOne {
...
func (_c *DBCacheCreateBulk) Save(ctx context.Context) ([]*DBCache, error) {
	if _c.err != nil {
		return nil, _c.err
	}
	specs := make([]*sqlgraph.CreateSpec, len(_c.builders))
	nodes := make([]*DBCache, len(_c.builders))
...
func (_c *DBCacheCreateBulk) SaveX(ctx context.Context) []*DBCache {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
// Exec executes the query.
func (_c *DBCacheCreateBulk) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *DBCacheCreateBulk) ExecX(ctx context.Context) {
	if err := _c.Exec(ctx); err != nil {
		panic(err)
	}
}
...
//		}).
//		Exec(ctx)
func (_c *DBCacheCreateBulk) OnConflict(opts ...sql.ConflictOption) *DBCacheUpsertBulk {
	_c.conflict = opts
...
//		OnConflict(sql.ConflictColumns(columns...)).
//		Exec(ctx)
func (_c *DBCacheCreateBulk) OnConflictColumns(columns ...string) *DBCacheUpsertBulk {
	_c.conflict = append(_c.conflict, sql.ConflictColumns(columns...))
	return &DBCacheUpsertBulk{
		create: _c,
	}
