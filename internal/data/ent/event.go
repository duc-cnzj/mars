	...
	for i := range columns {
		...
		case event.FieldAction:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.Action = types.EventActionType(value.Int64)
			}
...
func (_m *Event) QueryFile() *FileQuery {
	return NewEventClient(_m.config).QueryFile(_m)
}
...
func (_m *Event) String() string {
	...
	builder.WriteString(_m.Old)
	builder.WriteString(", ")
	builder.WriteString("new=")
	builder.WriteString(_m.New)
	builder.WriteString(", ")
	builder.WriteString("has_diff=")
	builder.WriteString(fmt.Sprintf("%v", _m.HasDiff))
	builder.WriteString(", ")
