...
// OldNamespaceID returns the old "namespace_id" field's value of the Member entity.
// If the Member object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
func (m *MemberMutation) ClearNamespaceID() {
	m.namespace = nil
	m.clearedFields[member.FieldNamespaceID] = struct{}{}
}

// NamespaceIDCleared returns if the "namespace_id" field was cleared in this mutation.
func (m *MemberMutation) NamespaceIDCleared() bool {
	_, ok := m.clearedFields[member.FieldNamespaceID]
	return ok
}
...
func (m *MemberMutation) ResetNamespaceID() {
	m.namespace = nil
	delete(m.clearedFields, member.FieldNamespaceID)
}
...
func (m *MemberMutation) Fields() []string {
	...
	if m.namespace != nil {
		fields = append(fields, member.FieldNamespaceID)
	}
	return fields
}
...
func (m *MemberMutation) ClearedFields() []string {
	...
	if m.FieldCleared(member.FieldNamespaceID) {
		fields = append(fields, member.FieldNamespaceID)
	}
	return fields
}
...
func (m *MemberMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.namespace != nil {
		edges = append(edges, member.EdgeNamespace)
	}
	return edges
}
...
// OldPrivate returns the old "private" field's value of the Namespace entity.
// If the Namespace object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
