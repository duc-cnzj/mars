...
func (_q *EventQuery) QueryFile() *FileQuery {
...
func (_q *EventQuery) WithFile(opts ...func(*FileQuery)) *EventQuery {
	query := (&FileClient{config: _q.config}).Query()
...
func (_q *EventQuery) loadFile(ctx context.Context, query *FileQuery, nodes []*Event, init func(*Event), assign func(*Event, *File)) error {
...
func (_q *EventQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withFile != nil {
			_spec.Node.AddColumnOnce(event.FieldFileID)
		}
	}
