...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Member, c.Namespace, c.Project, c.Repo, c.User,
	} {
		n.Use(hooks...)
	}
}
...
// UpdateOne returns an update builder for the given entity.
func (c *CacheLockClient) UpdateOne(_m *CacheLock) *CacheLockUpdateOne {
	mutation := newCacheLockMutation(c.config, OpUpdateOne, withCacheLock(_m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *CacheLockClient) DeleteOne(_m *CacheLock) *CacheLockDeleteOne {
	return c.DeleteOneID(_m.ID)
}
...
func (c *ChangelogClient) QueryProject(_m *Changelog) *ProjectQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *DBCacheClient) UpdateOne(_m *DBCache) *DBCacheUpdateOne {
	mutation := newDBCacheMutation(c.config, OpUpdateOne, withDBCache(_m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *DBCacheClient) DeleteOne(_m *DBCache) *DBCacheDeleteOne {
	return c.DeleteOneID(_m.ID)
}
...
func (c *EventClient) QueryFile(_m *Event) *FileQuery {
...
func (c *FavoriteClient) QueryNamespace(_m *Favorite) *NamespaceQuery {
...
func (c *MemberClient) QueryNamespace(_m *Member) *NamespaceQuery {
	query := (&NamespaceClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
func (c *NamespaceClient) QueryFavorites(_m *Namespace) *FavoriteQuery {
...
func (c *NamespaceClient) QueryMembers(_m *Namespace) *MemberQuery {
...
func (c *ProjectClient) QueryChangelogs(_m *Project) *ChangelogQuery {
...
func (c *ProjectClient) QueryRepo(_m *Project) *RepoQuery {
...
func (c *RepoClient) QueryProjects(_m *Repo) *ProjectQuery {
	query := (&ProjectClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		...
		Namespace, Project, Repo, User []ent.Hook
	}
	inters struct {
		AccessToken, CacheLock, Changelog, DBCache, Event, Favorite, File, Member,
		Namespace, Project, Repo, User []ent.Interceptor
	}
)
