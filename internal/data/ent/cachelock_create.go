...
func (_c *CacheLockCreate) SetKey(v string) *CacheLockCreate {
	_c.mutation.SetKey(v)
	return _c
}

// SetOwner sets the "owner" field.
func (_c *CacheLockCreate) SetOwner(v string) *CacheLockCreate {
	_c.mutation.SetOwner(v)
	return _c
}

// SetExpiredAt sets the "expired_at" field.
func (_c *CacheLockCreate) SetExpiredAt(v time.Time) *CacheLockCreate {
	_c.mutation.SetExpiredAt(v)
	return _c
}

// SetNillableExpiredAt sets the "expired_at" field if the given value is not nil.
func (_c *CacheLockCreate) SetNillableExpiredAt(v *time.Time) *CacheLockCreate {
	if v != nil {
		_c.SetExpiredAt(*v)
	}
	return _c
...
func (_c *CacheLockCreate) Mutation() *CacheLockMutation {
	return _c.mutation
}

// Save creates the CacheLock in the database.
func (_c *CacheLockCreate) Save(ctx context.Context) (*CacheLock, error) {
	return withHooks(ctx, _c.sqlSave, _c.mutation, _c.hooks)
}

// SaveX calls Save and panics if Save returns an error.
func (_c *CacheLockCreate) SaveX(ctx context.Context) *CacheLock {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (_c *CacheLockCreate) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *CacheLockCreate) ExecX(ctx context.Context) {
...
func (_c *CacheLockCreate) check() error {
...
func (_c *CacheLockCreate) sqlSave(ctx context.Context) (*CacheLock, error) {
...
func (_c *CacheLockCreate) createSpec() (*CacheLock, *sqlgraph.CreateSpec) {
	var (
		_node = &CacheLock{config: _c.config}
...
//		}).
//		Exec(ctx)
func (_c *CacheLockCreate) OnConflict(opts ...sql.ConflictOption) *CacheLockUpsertOne {
	_c.conflict = opts
...
//		Exec(ctx)
func (_c *CacheLockCreate) OnConflictColumns(columns ...string) *CacheLockUpsertOne {
...
func (_c *CacheLockCreateBulk) Save(ctx context.Context) ([]*CacheLock, error) {
	if _c.err != nil {
		return nil, _c.err
	}
	specs := make([]*sqlgraph.CreateSpec, len(_c.builders))
	nodes := make([]*CacheLock, len(_c.builders))
...
func (_c *CacheLockCreateBulk) SaveX(ctx context.Context) []*CacheLock {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
// Exec executes the query.
func (_c *CacheLockCreateBulk) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *CacheLockCreateBulk) ExecX(ctx context.Context) {
	if err := _c.Exec(ctx); err != nil {
		panic(err)
	}
}
...
//		}).
//		Exec(ctx)
func (_c *CacheLockCreateBulk) OnConflict(opts ...sql.ConflictOption) *CacheLockUpsertBulk {
	_c.conflict = opts
...
//		OnConflict(sql.ConflictColumns(columns...)).
//		Exec(ctx)
func (_c *CacheLockCreateBulk) OnConflictColumns(columns ...string) *CacheLockUpsertBulk {
	_c.conflict = append(_c.conflict, sql.ConflictColumns(columns...))
	return &CacheLockUpsertBulk{
		create: _c,
	}
