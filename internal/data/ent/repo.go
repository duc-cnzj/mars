...
func (_m *Repo) QueryProjects() *ProjectQuery {
	return NewRepoClient(_m.config).QueryProjects(_m)
}
...
func (_m *Repo) String() string {
	...
	builder.WriteString(_m.GitProjectName)
	builder.WriteString(", ")
	...
	builder.WriteString(fmt.Sprintf("%v", _m.NeedGitRepo))
	builder.WriteString(", ")
	builder.WriteString("mars_config=")
	builder.WriteString(fmt.Sprintf("%v", _m.MarsConfig))
	builder.WriteString(", ")
