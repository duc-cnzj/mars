...
// Source: github.com/duc-cnzj/mars/v6/internal/uploader (interfaces: Uploader,File,FileInfo)
//
// Generated by this command:
//
//	mockgen -destination ./mock_uploader.go -package uploader github.com/duc-cnzj/mars/v6/internal/uploader Uploader,File,FileInfo
//
...
func (m *MockUploader) Disk(s string) Uploader {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Disk", s)
	ret0, _ := ret[0].(Uploader)
	return ret0
}

// Disk indicates an expected call of Disk.
func (mr *MockUploaderMockRecorder) Disk(s any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Disk", reflect.TypeOf((*MockUploader)(nil).Disk), s)
}
...
func (m *MockUploader) Read(path string) (io.ReadCloser, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUploaderMockRecorder) Read(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockUploader)(nil).Read), path)
}
