...
// Source: github.com/duc-cnzj/mars/internal/plugins (interfaces: PubSub)
...
func (m *MockPubSub) ToAll(arg0 plugins.WebsocketMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockPubSub) ToOthers(arg0 plugins.WebsocketMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockPubSub) ToSelf(arg0 plugins.WebsocketMessage) error {
	m.ctrl.T.Helper()
