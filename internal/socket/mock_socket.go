...
// Source: github.com/duc-cnzj/mars/v4/internal/socket (interfaces: JobManager,Job,Percentable,Conn,PtyHandler,TaskManager,GorillaWs,SessionMapper,ReleaseInstaller,DeployMsger)
//
// Generated by this command:
//
//	mockgen -destination ./mock_socket.go -package socket github.com/duc-cnzj/mars/v4/internal/socket JobManager,Job,Percentable,Conn,PtyHandler,TaskManager,GorillaWs,SessionMapper,ReleaseInstaller,DeployMsger
//
