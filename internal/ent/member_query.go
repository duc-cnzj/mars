...
func (mq *MemberQuery) QueryNamespace() *NamespaceQuery {
	query := (&NamespaceClient{config: mq.config}).Query()
...
func (mq *MemberQuery) loadNamespace(ctx context.Context, query *NamespaceQuery, nodes []*Member, init func(*Member), assign func(*Member, *Namespace)) error {
