...
// Source: github.com/duc-cnzj/mars/v5/internal/application (interfaces: PluginManger,Picture,Project,App,WsHttpServer,PubSub,WsSender,GitServer,Commit,DomainManager,Pipeline,Branch,ProjectPodEventPublisher,HttpHandler)
//
// Generated by this command:
//
//	mockgen -destination ./mock_types.go -package application github.com/duc-cnzj/mars/v5/internal/application PluginManger,Picture,Project,App,WsHttpServer,PubSub,WsSender,GitServer,Commit,DomainManager,Pipeline,Branch,ProjectPodEventPublisher,HttpHandler
//
...
import (
	...
	cache "github.com/duc-cnzj/mars/v5/internal/cache"
	config "github.com/duc-cnzj/mars/v5/internal/config"
	cron "github.com/duc-cnzj/mars/v5/internal/cron"
	...
	locker "github.com/duc-cnzj/mars/v5/internal/locker"
	mlog "github.com/duc-cnzj/mars/v5/internal/mlog"
...
func (mr *MockBranchMockRecorder) GetName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetName", reflect.TypeOf((*MockBranch)(nil).GetName))
}
...
func (mr *MockBranchMockRecorder) GetWebURL() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWebURL", reflect.TypeOf((*MockBranch)(nil).GetWebURL))
}
...
func (mr *MockBranchMockRecorder) IsDefault() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsDefault", reflect.TypeOf((*MockBranch)(nil).IsDefault))
}
...
type MockProjectPodEventPublisherMockRecorder struct {
	mock *MockProjectPodEventPublisher
}
...
func NewMockProjectPodEventPublisher(ctrl *gomock.Controller) *MockProjectPodEventPublisher {
	mock := &MockProjectPodEventPublisher{ctrl: ctrl}
	mock.recorder = &MockProjectPodEventPublisherMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProjectPodEventPublisher) EXPECT() *MockProjectPodEventPublisherMockRecorder {
	return m.recorder
}
