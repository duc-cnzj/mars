...
// Source: github.com/duc-cnzj/mars/v5/internal/application (interfaces: PluginManger,Picture,Project,App,WsHttpServer,PubSub,WsSender,GitServer,Commit,DomainManager,Pipeline,Branch,ProjectPodEventPublisher)
//
// Generated by this command:
//
//	mockgen -destination ./mock_types.go -package application github.com/duc-cnzj/mars/v5/internal/application PluginManger,Picture,Project,App,WsHttpServer,PubSub,WsSender,GitServer,Commit,DomainManager,Pipeline,Branch,ProjectPodEventPublisher
//
